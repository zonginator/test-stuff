        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('devopsTaskApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-devopsTaskApp-error');
                                var entityKey = httpResponse.headers('X-devopsTaskApp-params');
                                if (errorHeader) {
